      ...
      <main class="flex flex-col items-center justify-center h-full w-full">
        <transition name="fade-up-down">
          <div v-show="modal" class="modal-wrapper flex items-center z-30">
            <div
              class="modal max-w-md mx-4 md:w-[700px] bg-secondary-light dark:bg-primary-dark max-h-screen shadow-lg flex-row rounded-3xl relative"
            >
              <div
                ...
                <form class="max-w-xl m-4 text-left">
                  ...
                  <div class="mt-5 pb-3 sm:pb-1">
                    <a
                      ...
                      class="mt-0 px-4 sm:px-6 py-2 sm:py-3 text-white bg-blue-500 hover:bg-indigo-600 rounded-full focus:ring-1 focus:ring-indigo-900 duration-500"
              ...
              >
                <Button
                  title="Close"
                  class="px-4 sm:px-6 py-2 bg-gray-500 text-primary-light hover:bg-ternary-dark dark:bg-gray-200 dark:text-secondary-dark dark:hover:bg-primary-light rounded-full focus:ring-1 focus:ring-indigo-900 duration-500"
                  @click="showModal()"
